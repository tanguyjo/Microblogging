  ...
  <div class="min-h-screen flex items-center justify-center bg-white px-6">
    <div class="w-full max-w-sm">
      ...
      <form @submit.prevent="handleLogin" class="mt-8 space-y-4">
        ...
        <button
          type="submit"
          class="w-full bg-darkviolet text-white font-bold py-3 rounded-sm hover:bg-darkviolet transition disabled:opacity-50"
          :disabled="loading"
        >
...
const handleLogin = async () => {
  try {
    ...
    // Stocker le token, le nom d'utilisateur et l'ID dans le localStorage
